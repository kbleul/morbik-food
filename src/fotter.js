        ...
        <footer className="mt-40 bg-gray-100">
            <article className=" pb-24 pt-32 flex w-full">
                <section className="w-4/12 text-center mr-2 hover:border-b-2 hover:border-green-400">
                    <h3 className="font-black text-2xl pb-2 font-serif uppercase">API<span className="lowercase">s</span> Used</h3><hr/>
                ...
                <section className="w-4/12 flex justify-center items-center font-black text-lg uppercase hover:border-l-2 hover:border-green-400">
