...
const Navigation = ({ setnavChoice, set_choicetype, set_togglerecipe_page }) => {
  ...
  return (
    <section className="w-1/4 h-screen overflow-y-scroll overscroll-y-auto mt-16">
      <div>
